...
\item Alsharqi, M., et al. A dataset of EEG recordings from patients with schizophrenia and healthy controls (ASZED / public schizophrenia EEG). OpenNeuro / Zenodo.
\item Kiva Microfunds. Kiva snapshot: anonymized loan-level records. \url{https://www.kiva.org/build/data-snapshots}
\item Chawla, N. V., Bowyer, K. W., Hall, L. O., and Kegelmeyer, W. P. (2002). SMOTE: Synthetic Minority Over-sampling Technique. Journal of Artificial Intelligence Research, 16, 321--357.
\item Breiman, L. (1996). Bagging Predictors. Machine Learning, 24(2), 123--140.
\item Varoquaux, G. (2018). Cross-validation failure: Small sample sizes lead to large error bars. NeuroImage, 180, 68--77.
\end{enumerate}}